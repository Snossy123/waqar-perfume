                        ...
                        <div class="modal-content">
                            <form action="{{ route('admin.VehicleStatus.store') }}" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="brandName" class="form-label">Vehicle Status Name (Ar)</label>
                                        <input type="text" class="form-control" id="brandName" name="name_ar" required>

                                    </div>
                                    <div class="mb-3">
                                        <label for="brandName" class="form-label">Vehicle Status Name (En)</label>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <form action="{{ route('admin.VehicleStatus.edit', $item->id) }}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="editBrandNameAr{{ $item->id }}" class="form-label">Vehicle Status Name (Ar)</label>
                                                    <input type="text" class="form-control" id="editBrandNameAr{{ $item->id }}" name="name_ar" value="{{ $item->getTranslation('name','ar') }}" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="editBrandNameEn{{ $item->id }}" class="form-label">Vehicle Status Name (En)</label>
