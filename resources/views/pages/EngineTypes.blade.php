                        ...
                        <div class="modal-content">
                            <form action="{{ route('admin.EngineType.store') }}" method="POST">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <label for="brandName" class="form-label">Engine Types Name (Ar)</label>
                                        <input type="text" class="form-control" id="brandName" name="name_ar" required>

                                    </div>
                                    <div class="mb-3">
                                        <label for="brandName" class="form-label">Engine Types Name (En)</label>
                                ...
                                <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                        <form action="{{ route('admin.EngineType.edit', $item->id) }}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                <div class="mb-3">
                                                    <label for="editBrandName{{ $item->id }}" class="form-label">Engine Types Name (Ar)</label>
                                                    <input type="text" class="form-control" id="editBrandName{{ $item->id }}" name="name_ar" value="{{ $item->getTranslation('name', 'ar') }}" required>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="editBrandName{{ $item->id }}" class="form-label">Engine Types Name (En)</label>
